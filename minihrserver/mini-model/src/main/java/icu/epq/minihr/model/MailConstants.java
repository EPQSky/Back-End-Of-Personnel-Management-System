...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "epq.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "epq.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "epq.mail.routing.key";
}
